...
namespace KopiLua
{
	...
	public partial class Lua
	{
		...
		*/
		...
		//[Conditional("DEBUG")]
		internal static void lua_assert(bool c) {Lua.Assert(c);}

		//[Conditional("DEBUG")]
		internal static void lua_assert(int c) { Lua.Assert(c != 0); }
		...
		internal static int cast_int(object i) { Lua.Assert(false, "Can't convert int."); return Convert.ToInt32(i); }
		...
		internal static lua_Number cast_num(object i) { Lua.Assert(false, "Can't convert number."); return Convert.ToSingle(i); }
